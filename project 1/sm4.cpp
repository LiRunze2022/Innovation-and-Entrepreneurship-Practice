...
void sm4enc(word8 c[16], word8 m[16], word8 key[16])
{
    ...
    for(int i = 0; i < 32; i++)
    {
        for(int j = 0; j < 3; j++)
        {
            output[j * 4 + 0] = input[(j + 1) * 4 + 0];
            output[j * 4 + 1] = input[(j + 1) * 4 + 1];
            output[j * 4 + 2] = input[(j + 1) * 4 + 2];
            output[j * 4 + 3] = input[(j + 1) * 4 + 3];
        }

        word32 new_block, x0, x1, x2, x3;
        x0 = ((word32)input[0] << 24) ^ ((word32)input[1] << 16) ^ ((word32)input[2] << 8) ^ (word32)input[3];
        x1 = ((word32)input[4] << 24) ^ ((word32)input[5] << 16) ^ ((word32)input[6] << 8) ^ (word32)input[7];
        x2 = ((word32)input[8] << 24) ^ ((word32)input[9] << 16) ^ ((word32)input[10] << 8) ^ (word32)input[11];
        x3 = ((word32)input[12] << 24) ^ ((word32)input[13] << 16) ^ ((word32)input[14] << 8) ^ (word32)input[15];
        new_block = sm4F(x0, x1, x2, x3, roundkey[i]);

        output[12] = (word8)(new_block >> 24);
        output[13] = (word8)(new_block >> 16);
        output[14] = (word8)(new_block >> 8);
        output[15] = (word8)(new_block);
    ...
    for(int i = 0; i < 4; i++)
    {
        c[i * 4 + 0] = output[(3 - i) * 4 + 0];
        c[i * 4 + 1] = output[(3 - i) * 4 + 1];
        c[i * 4 + 2] = output[(3 - i) * 4 + 2];
        c[i * 4 + 3] = output[(3 - i) * 4 + 3];
    }
}
...
void sm4dec(word8 c[16], word8 m[16], word8 key[16])
{
    ...
    for(int i = 0; i < 32; i++)
    {
        ...
        x2 = ((word32)input[8] << 24) ^ ((word32)input[9] << 16) ^ ((word32)input[10] << 8) ^ (word32)input[11];
        x3 = ((word32)input[12] << 24) ^ ((word32)input[13] << 16) ^ ((word32)input[14] << 8) ^ (word32)input[15];
        new_block = sm4F(x0, x1, x2, x3, roundkey[31 - i]);
    ...
    for(int i = 0; i < 4; i++)
    {
        m[i * 4 + 0] = output[(3 - i) * 4 + 0];
        m[i * 4 + 1] = output[(3 - i) * 4 + 1];
        m[i * 4 + 2] = output[(3 - i) * 4 + 2];
        m[i * 4 + 3] = output[(3 - i) * 4 + 3];
    }
}
...
int main() {
    ...
    std::uniform_int_distribution<> dis(0, 255); // 均匀分布
    ...
    // 输出结果
    cout << "测试完成: " << NUM_TESTS << " 次随机加密" << endl;
    cout << "平均加密时间: " << fixed << setprecision(4) << average << " 毫秒" << endl;
    cout << "总耗时: " << fixed << setprecision(2) << total << " 毫秒" << endl;
    return 0;
}
/*
int main()
